#!/usr/bin/env python3
"""Pack the extracted Vita cardfaces into an encrypted .bin for the repo.

Reads .shots/vita-faces-2third.png (7x6 grid of 180x222 faces, quantized),
encrypts with AES-256-GCM, writes public/assets/vita-faces.bin.
...
SRC = ".shots/vita-faces-2third.png"
DST = "public/assets/vita-faces.bin"
# arbitrary fixed passphrase -> key; ships in src/render/vitaassets.ts
PASSPHRASE = b"mj2-personal-2026-vita-faces"
